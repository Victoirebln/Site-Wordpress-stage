...
if ( ! class_exists( 'Web_Developer_Elementor_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class Web_Developer_Elementor_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new Web_Developer_Elementor_WPTT_WebFont_Loader( $url );
